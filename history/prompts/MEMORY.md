...
## Constitution
- [Establish Calculator Constitution](constitution/1-establish-calculator-constitution.constitution.prompt.md) — Project governance for Python calculator with type hints and uv
...
- [Implement Phase 5 and Phase 6 Error Handling](001-basic-calculator/7-implement-phase-5-and-phase-6-error-handling.green.prompt.md) — User Story 3 (negative numbers) and User Story 4 (division by zero) complete; 33/33 tests pass
